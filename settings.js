...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "icxzFZTI#ajUoNip1y4ByvuGDvSR907GXp4DSgBLf-GDR23h0cn0", // Add your session id
PREFIX: process.env.PREFIX || ".",
MODE: process.env.MODE || "private",  //public | private | inbox | group
OWNER_NUMBER: process.env.OWNER_NUMBER || "94788582834",
DEV: process.env.DEV || "94788582834",
